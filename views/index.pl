 ...
 * Programa: Prototipo de sistema experto que permita diagnosticar el nivel de
   depresión en los estudiantes de la Universidad Nacional Santiago Antúnez de
   Mayolo como apoyo al trabajo de los psicólogos.
 */

/* Libraries
 * library(pce): Proporciona gráficos a SWI-Prolog
...
home:- new(Window,dialog('Inicio')),
       ...
       new(BtnDiagnosticar,button('Realizar Diagnóstico',message(@prolog,diagnostic_window))),
...
diagnostic_window :- new(DW,dialog('Diagnosticar paciente')),
                  ...
                  new(Txt6,label(name,'C) Esta despierto durante la noche, cualquier ocasión de levantarse de la cama se clasifica en 2',font('arial','',10))),
                  ...
                  new(InsomioTardio, menu('3.-¿Insomnio tardío?')),
...
dignostico(1,'Depresión ligera/menor').
dignostico(2,'Depresión ligera/menor').
dignostico(3,'Depresión moderada').
dignostico(4,'Depresión moderada').
dignostico(5,'Depresión severa').
dignostico(6,'Depresión muy severa').
